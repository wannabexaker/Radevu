      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        ...
        <div className="grid gap-6 text-base leading-relaxed text-slate-700 md:grid-cols-2">
          <p>
            ...
            software. Κουρείς, οδοντίατροι, δασκάλες, λογιστές, τεχνικοί -
          ...
          <p>
            ...
            enterprise platform - αν χρειαστείς βοήθεια, μιλάς με τον άνθρωπο
            που το έφτιαξε. Στο beta είναι δωρεάν για όλους, γιατί ο στόχος
            είναι να αποδειχθεί ότι λειτουργεί στην πράξη, όχι να εισπράξει.
          </p>
        </div>
      </div>
    </section>
