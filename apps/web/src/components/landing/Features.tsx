...
const features: Feature[] = [
  {
    ...
    description:
      "Δώσε ένα link, ο πελάτης κλείνει σε 60 δευτερόλεπτα από το κινητό."
  },
  {
    icon: Users,
    title: "Ιστορικό πελατών",
    description:
      "Δες σε ένα tap τι έχει κάνει κάθε πελάτης, τι ζήτησε, τι χρωστάει."
  },
  {
    icon: Mail,
    title: "Email + ημερολόγιο",
    description:
      "Κάθε κράτηση έρχεται με επιβεβαίωση και calendar invite στον πελάτη."
  },
  {
    icon: Smartphone,
    title: "Mobile-first",
    description:
      "Σχεδιασμένο σαν εφαρμογή στο κινητό σου, όχι σαν responsive site."
  },
  {
    icon: Zap,
    title: "≤2 taps",
  ...
  {
    icon: Gift,
    title: "Δωρεάν στο beta",
    description:
      "Χρησιμοποίησέ το ελεύθερα όσο είμαστε στο beta. Καμία κάρτα."
  }
];
